...
<Tabs>
  <Tab title="VS Code Marketplace">
    ...
    **Compatible IDEs:** VS Code, Cursor, Windsurf, GitHub Codespaces, Amazon Kiro
  </Tab>
  <Tab title="Open VSX Registry">
    Install from Open VSX for open-source IDEs:

    1. Open your IDE (Google Antigravity, VSCodium, Gitpod, etc.)
    2. Go to Extensions
    3. Search for "specsmd"
    4. Click **Install**
    ...
    **Compatible IDEs:** Google Antigravity, VSCodium, Gitpod, Google IDX, Eclipse Theia, Code-Server
  </Tab>
...
<AccordionGroup>
  ...
  <Accordion title="Extension not working in Cursor/Windsurf/other IDEs">
    The extension is compatible with VS Code-based IDEs. Install from:
    - **VS Code Marketplace** for VS Code, Cursor, Windsurf, GitHub Codespaces, Amazon Kiro
    - **Open VSX Registry** for Google Antigravity, VSCodium, Gitpod, Google IDX, Eclipse Theia, Code-Server
    - **VSIX file** for manual installation in any compatible IDE
  </Accordion>
</AccordionGroup>
