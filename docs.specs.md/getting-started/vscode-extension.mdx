...
<Tabs>
  ...
  <Tab title="Open VSX Registry">
    ...
    1. Open your IDE (VSCodium, Gitpod, Google IDX, etc.)
    2. Go to Extensions
    3. Search for "specsmd"
    4. Click **Install**
    ...
    **Compatible IDEs:** VSCodium, Gitpod, Google IDX, Eclipse Theia, Code-Server
  </Tab>
...
<AccordionGroup>
  ...
  <Accordion title="Extension not working in Cursor/Windsurf/other IDEs">
    ...
    - **Open VSX Registry** for VSCodium, Gitpod, Google IDX, Eclipse Theia, Code-Server
