...
The specsmd IDE extension provides a visual dashboard for tracking your AI-DLC development progress. Monitor bolts, browse specs, and see project metrics—all from your IDE sidebar.
