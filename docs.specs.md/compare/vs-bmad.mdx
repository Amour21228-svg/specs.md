...
**specs.md** uses 4 phase-based agents aligned to AI-DLC's methodology (Master, Inception, Construction, Operations).
...
**specs.md**: 4 phase-based agents aligned to methodology
...
| Simpler mental model (4 agents) | specs.md |
...
<Info>
**Bottom Line**: Both target complex systems. specs.md offers a formal methodology with fewer agents. BMAD offers maximum customization with 19+ role-based agents.
