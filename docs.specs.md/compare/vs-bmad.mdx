...
description: "Compare specs.md (AI-DLC) with BMAD's multi-agent framework"
---
...
**specs.md (AI-DLC)** uses 4 phase-based agents aligned to AI-DLC's methodology (Master, Inception, Construction, Operations).

---

## Side-by-Side Comparison

| Aspect | specs.md (AI-DLC) | BMAD |
|--------|-------------------|------|
...
| **Agent Philosophy** | 4 phase-based agents | 19+ role-based agents |
...
**specs.md (AI-DLC)**: 4 phase-based agents aligned to methodology
...
**specs.md (AI-DLC)**: AWS's formally defined AI-DLC methodology with specific phases, rituals, and artifacts documented in a whitepaper.

### 3. Design Technique Integration

**BMAD**: Design techniques are optional. Teams can choose their own approach.

**specs.md (AI-DLC)**: DDD is integrated as core. AI applies domain-driven design principles during decomposition—it's not optional.

### 4. Rituals and Collaboration

**BMAD**: Agents hand off documents to each other asynchronously.

**specs.md (AI-DLC)**: Mob Elaboration and Mob Construction are collocated rituals where teams work together with AI in real-time.
...
| BMAD Agents | specs.md (AI-DLC) Phase |
|-------------|------------------------|
...
<Steps>
  <Step title="Map Your Agents">
    Understand how your 19 agents map to 4 AI-DLC phases
  </Step>
...
|---------------|----------|
| Formal AWS methodology | specs.md (AI-DLC) |
| Maximum agent customization | BMAD |
| Simpler mental model (4 agents) | specs.md (AI-DLC) |
| Role-based simulation (19+ agents) | BMAD |
| DDD as core requirement | specs.md (AI-DLC) |
| Collocated Mob rituals | specs.md (AI-DLC) |
| Async agent handoffs | BMAD |

<Info>
**Bottom Line**: Both target complex systems. specs.md (AI-DLC) offers a formal methodology with fewer agents. BMAD offers maximum customization with 19+ role-based agents.
