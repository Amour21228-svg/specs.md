...
description: "Compare specs.md (AI-DLC) with OpenSpec's change-centric approach"
---
...
**specs.md (AI-DLC)** is a full lifecycle methodology covering Inception through Operations, with support for both greenfield and brownfield development.

---

## Side-by-Side Comparison

| Aspect | specs.md (AI-DLC) | OpenSpec |
|--------|-------------------|----------|
...
**specs.md (AI-DLC)**: Full lifecycle. Designed for complex systems from inception through operations.
...
**specs.md (AI-DLC)**: Memory Bank provides structured context, but sends more comprehensive context to ensure AI understands the full picture.

| Approach | Token Usage | Best For |
|----------|-------------|----------|
| OpenSpec | Lower | High-volume small changes |
| specs.md (AI-DLC) | Higher | Complex decisions requiring full context |

### 3. Brownfield Handling

**OpenSpec**: Primary design focus. Every change is explicit with clear before/after separation.

**specs.md (AI-DLC)**: Supported via "model elevation" - AI first converts existing code to semantic models (domain components, relationships) before making changes.
...
**specs.md (AI-DLC)**: A complete methodology with:
...
| Use Case | OpenSpec | specs.md (AI-DLC) |
|----------|----------|-------------------|
...
<Steps>
  <Step title="Use specs.md (AI-DLC) for Planning">
...
| Greenfield development | specs.md (AI-DLC) |
| Token efficiency | OpenSpec |
| Full lifecycle | specs.md (AI-DLC) |
| Minimal setup | OpenSpec |
| DDD integration | specs.md (AI-DLC) |
| Team rituals | specs.md (AI-DLC) |
| High-volume small changes | OpenSpec |

<Info>
**Bottom Line**: OpenSpec excels at brownfield changes with minimal overhead. specs.md (AI-DLC) provides full lifecycle support for complex systems.
