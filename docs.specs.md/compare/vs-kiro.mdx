...
**specs.md (AI-DLC)**:
- Free (open source)
- Pay only for your AI API tokens (~$2-5 per feature)
...
## Cost Comparison (Annual, Solo Developer)

| Tool | Year 1 Cost |
|------|-------------|
| specs.md | ~$50-100 (API tokens only) |
| Kiro Pro | $228 + usage limits |
| Kiro Pro+ | $468 + usage limits |
